...
Across both German and US legislative periods, news coverage of all four leaders is dominated by negative tone, with positive stories consistently forming a much smaller share and neutral coverage filling the remaining space. Within this overall pattern, there are marked differences: some leaders receive a particularly high share of negative articles in both periods, while others show more balanced or shifting tone profiles over time. This suggests that media narratives about political leaders are not only generally critical, but also shaped by country-specific contexts and changes between legislative periods, which can amplify or soften negative portrayals. But due to the much larger number of articles about US leaders, we should be cautious in directly comparing the tone distributions between the two country blocs.
""")
